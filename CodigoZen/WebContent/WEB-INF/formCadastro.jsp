...
<%
	String message = "Aviso! O Peso Liquido não pode ser Menor do que Peso Bruto";
%>
<link rel="stylesheet"
		...
		<div align="center">
			...
			<div
				...
				<form class="needs-validation" novalidate>
					...
					<div class="form-row">
						<div class="col-md-12 mb-3">
							<label for="vehicle">Veiculo de Aplicação:</label> <input
					...
					<div class="form-row">
						<div class="col-md-12 mb-3">
							<label for="netWeight">Peso Liquido:</label> <input type="text"
